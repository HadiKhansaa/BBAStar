...
#define MAX_BINS 5000         // Maximum number of bins (adjust as needed) // should be adjusted dynamically
#define MAX_BIN_SIZE 10000     // Maximum number of nodes per bin (adjust as needed) // should be adjusted dynamically
